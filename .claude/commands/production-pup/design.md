...
Run the design and anti-vibecoding-focused Production Pup audit.

Read `SKILL.md` first and use its Anti-Vibe-Coding Design Audit and Design System sections as the source of truth.
